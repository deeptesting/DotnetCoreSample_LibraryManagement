...
namespace LibraryBusinessComponents.Concrete
{
    public class BookBusinessComponent : IBookBusinessComponent
    {
        ...
        IEmailFacades _emailFacades;
        IConfiguration _configuration;

        public BookBusinessComponent(IBookRepository bookRepository, IEmailFacades emailFacades, IConfiguration configuration)
        {
            _bookRepository = bookRepository;
            _emailFacades = emailFacades;
        ...
        public async Task<LibraryAssets> GetBookDetails(string BookId)
        {
            ...
            string cnctnString = _configuration["ConnectionStrings:EmployeeDBConnection"];
