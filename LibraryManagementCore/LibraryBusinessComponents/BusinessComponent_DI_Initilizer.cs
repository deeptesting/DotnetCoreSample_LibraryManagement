...
using LibraryBusinessFacades.Concrete;
...
namespace LibraryBusinessComponents
{
    ...
    public static class BusinessComponent_DI_Initilizer
    {
        ...
        {
            string cnctnString = configuration["ConnectionStrings:EmployeeDBConnection"];
            ...
            services.AddScoped<IEmailFacades, SendGridEmailFacades>();
        }
    }
}
